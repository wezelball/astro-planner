...
@st.cache_data
def load_opengc_catalog(path= DATA_DIR / "NGC.csv"):
...
def main():
    ...
    catalog_df = load_openngc_catalog(DATA_DIR / "NGC.csv")

    horizon = parse_horizon_file(HORIZON_DIR / "GSpring_horizon.txt")
